...
public class InAcitveApartmentsDAO {

	private ArrayList<Apartment> InActiveApartments;
	private String path;
	
	public InAcitveApartmentsDAO() {
		...
		this.InActiveApartments = new ArrayList<Apartment>();
			...
			try {
				while ((line = in.readLine()) != null) {
					...
					while (st.hasMoreTokens()) {
						...
						if(!status.equals("INACTIVE"))	// Read inactive apartments
							continue;			
